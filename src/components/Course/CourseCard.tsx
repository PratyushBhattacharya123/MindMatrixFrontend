...
const CourseCard = ({ item, isProfile }: Props) => {
  ...
  return (
    ...
    >
      <div className="w-full min-h-[35vh] dark:bg-slate-500 bg-slate-200 dark:bg-opacity-20 backdrop-blur border dark:border-[#ffffff1d] border-[#00000015] dark:shadow-[bg-slate-700] rounded-lg p-3 shadow-sm dark:shadow-inner">
        <Image
