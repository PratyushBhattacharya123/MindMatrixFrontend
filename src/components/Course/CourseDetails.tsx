            ...
            <div className="flex items-center justify-between pt-3">
              <div className="flex items-center -ml-2">
                ...
                <h5 className="text-black dark:text-white">
                  {data?.reviews?.length}{" "}
                  {data?.reviews?.length === 0 ? "Review" : "Reviews"}
                </h5>
              </div>
              <h5 className="text-black dark:text-white">
                ...
                (review: any, index: number) => (
                  <div className="w-full p-4" key={index}>
                    <div className="flex">
                      ...
                      <div className="pl-2 md:hidden items-center">
                        <h5 className="text-[18px] pr-2 text-black dark:text-white">
                          {review.user.name}
                        </h5>
                        <Ratings rating={review.rating} />
            ...
            <div className="sticky top-[100px] left-0 z-50 w-full">
              ...
              <div className="flex items-center">
                ...
                <h4 className="pl-5 pt-4 text-[22px] text-black dark:text-white">
                  {discountPercentage(data.estimatedPrice, data.price)}% Off
                </h4>
              </div>
              ...
              <div className="flex items-center">
                {isPurchased ? (
                  <Link
                    className={`${styles.button} !w-[180px] my-3 font-Poppins cursor-pointer !bg-[crimson] text-center !text-white`}
